...
/**
  ...
  */
class Feature2(degreeOfSeparationChecker: DegreeOfSeparationChecker, sink: Sink) extends TransactionLabeler(sink) {
  private final val MAX_DEGREE_FOR_VERIFIED_LABEL = 2
  ...
  /**
    ...
    */
  def assignLabel(transaction: Transaction): String = {
